...
app = FastAPI(title="Remote HMI Gateway", version="3.2.0")
    ...
    try:
        while True:
            ...
            if data.get("type") == "PING":
                ...
                pong = json.dumps({"type": "PONG", "ts": connection_status["last_ping"]})
...
@app.get("/")
async def root():
    return {"status": "OK", "message": "Remote HMI Gateway Running", "version": "3.2.0"}
...
# ==========================================================
#  Frontend WebSocket (Live Status)
# ==========================================================
@app.websocket("/ws")
